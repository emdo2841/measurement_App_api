...
const createOrder = async (req, res) => {
    try {
        ...
        await (0, cache_1.delCache)(ordersListCacheKey(req.user.userId));
        ;
...
const getOrder = async (req, res) => {
    try {
        ...
        await (0, cache_1.setCache)(cachedKey, order);
        return res.status(200).json(order);
    }
    catch (error) {
...
const updateOrder = async (req, res) => {
    try {
        ...
        await (0, cache_1.delCache)(ordersListCacheKey(req.user.userId), orderCacheKey(req.user.userId, id));
        return res.status(200).json({ status: "successful", data: order });
    }
    catch (error) {
